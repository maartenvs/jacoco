...
import org.jacoco.core.test.filter.targets.StringSwitchTarget;
...
public class StringSwitchTest extends ValidationTestBase {
	...
	public StringSwitchTest() {
		super("src-java7", StringSwitchTarget.class);
	}
	...
	public void notCovered() {
		assertLine("notCovered", ICounter.NOT_COVERED, isJDKCompiler ? 4 : 9, 0);
	}
	...
	public void handwritten() {
		assertLine("handwritten.firstSwitch", ICounter.FULLY_COVERED, 0, 0);
		assertLine("handwritten.ignored", ICounter.EMPTY);
